<template>
  <div class="card-container">
    <div class="card-header">
      <h2 class="card-title">测试联系信息</h2>
      <span class="test-tip">（无需认证，直接从数据库查询）</span>
    </div>
    ...
    <div class="form-container">
      <el-form :model="form" label-width="80px">
        ...
        <div class="btn-group">
          <el-button type="primary" @click="getTestContactInfo">获取联系信息</el-button>
...
export default {
  ...
  methods: {
    getTestContactInfo() {
      ...
      // 调用测试的敏感数据接口，无需认证
      axios.get(`/system/test/sensitive/contact`, {
        params: {
